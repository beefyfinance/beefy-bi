...
export const RPC_API_URL_BEEFY_LINEA = process.env.RPC_API_URL_BEEFY_LINEA || null;
export const RPC_API_URL_BEEFY_OPTIMISM = process.env.RPC_API_URL_BEEFY_OPTIMISM || null;
export const RPC_API_URL_BEEFY_ROOTSTOCK = process.env.RPC_API_URL_BEEFY_ROOTSTOCK || null;
...
export const EXPLORER_URLS: {
  ...
  megaeth: { type: "etherscan-v2", url: "https://api.etherscan.io/v2/api" },
  ...
  robinhood: { type: "blockscout-api-v2", url: "https://robinhoodchain.blockscout.com/api/v2" },
...
export const MULTICALL3_ADDRESS_MAP: { [chain in Chain]: { multicallAddress: string; createdAtBlock: number } | null } = {
  ...
  megaeth: { multicallAddress: "0xcA11bde05977b3631167028862bE2a173976CA11", createdAtBlock: 1 },
  ...
  monad: { multicallAddress: "0xcA11bde05977b3631167028862bE2a173976CA11", createdAtBlock: 1 },
  ...
  plasma: { multicallAddress: "0xcA11bde05977b3631167028862bE2a173976CA11", createdAtBlock: 1 },
  ...
  robinhood: { multicallAddress: "0xcA11bde05977b3631167028862bE2a173976CA11", createdAtBlock: 1 },
