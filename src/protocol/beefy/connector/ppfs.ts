...
export function mapBeefyVaultShareRate<TObj, TKey extends string, TParams extends BeefyPPFSCallParams>(
  ...
  const process = (params: TParams[]) => fetchBeefyVaultShareRate(provider, chain, params);
