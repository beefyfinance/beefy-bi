...
import { optimizeRangeQueries } from "./optimize-range-queries";
import { RangeQueryOptimizerInput } from "./query-types";

describe("range optimizer", () => {
  ...
  it("should not update any input object", async () => {
    type T = RangeQueryOptimizerInput<{ key: string }, number>;
    const input: T = {
      objKey: (obj) => obj.key,
      states: [
        {
