select 
    ...
    interpolate(last(block_number, datetime)) as block_number,
    last(price, datetime) price
from datetime import datetime
from price_ts
where 
    datetime between '2022-09-22T12:50:20.000Z' and now() - '15 minutes'::interval
    and price_feed_id = 216334
group by 1;
